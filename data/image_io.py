...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 30 21:02:05 2020
...
def get_image_grid(images, shape, grid_width=0, grid_color=0,
    ...
    """
    reshaped = images.reshape(shape[0], shape[1], images.shape[1], images.shape[2])
...
def save_image(filepath, phrases, shape, inverted=True, grid_width=3,
    ...
    merged = get_image_grid(np.stack(merged_phrases), shape, grid_width,grid_color, frame)
